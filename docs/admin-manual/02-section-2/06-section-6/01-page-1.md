---
sidebar_position: 1
title: "2.5.1 Feature Overview"
toc: true
toc_max_heading_level: 6
toc_min_heading_level: 2
---

The Associated Applications feature manages the **relationship between hardware product models (PID) and Apps**, enabling devices under different sub-brands to be managed independently within their respective apps.
