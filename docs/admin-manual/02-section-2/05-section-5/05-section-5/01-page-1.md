---
sidebar_position: 1
title: "2.4.5.1 Unbind Device"
toc: true
toc_max_heading_level: 6
toc_min_heading_level: 2
---

Navigation Path: [Products] – [Device Manage]
...
![](/img/admin-manual/en/w_0069.png)
...
![](/img/admin-manual/en/w_0070.png)

Select and unbind specific devices on the current page.

![](/img/admin-manual/en/w_0071.png)

View device details in the** [Device After Sales]** Page and then unbind.

![](/img/admin-manual/en/w_0072.png)![](/img/admin-manual/en/w_0073.png)
...
![](/img/admin-manual/en/w_0076.png)(_Template Preview_)

![](/img/admin-manual/en/w_0077.png)
