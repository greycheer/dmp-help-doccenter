...
If you need to configure the apps available for a hardware product, or set the default download app for device QR scanning: 

- Please refer to **2.5: Associated Applications Configuration**