---
sidebar_position: 11
title: "2.2.1.2 Operation Manual"
toc: true
...
On the **Backend Categories** page, select **New Sub Item** or **Add**** A First Level C****ategory** according to the level you want to manage.
![](/img/admin-manual/en/w_0006.png)
...
![](/img/admin-manual/en/w_0007.png)
