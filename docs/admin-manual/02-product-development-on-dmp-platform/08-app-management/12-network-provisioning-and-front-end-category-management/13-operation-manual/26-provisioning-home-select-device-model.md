---
sidebar_position: 26
title: "Provisioning Home – Select Device Model"
toc: true
...
In general, there is no need to create a new top-level category; required categories can be created by clicking Add Sub Item.![](/img/admin-manual/w_0032.png)
