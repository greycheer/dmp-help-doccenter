---
sidebar_position: 30
title: "2.4.1.2 Operation Manual"
toc: true
...
When creating a knowledge base, you can select the target App and language.![](/img/admin-manual/w_0047.png)
![](/img/admin-manual/w_0048.png)**Notes:**
...
Click **[Manage****ment**** Q&A]** to enter the **[App Q&A Management]** page.
Then click **[Add First-level Category]** to create a top-level category.
![](/img/admin-manual/w_0049.png)
![](/img/admin-manual/w_0050.png)
...
2. When adding knowledge articles, make sure to configure multiple languages. Each language requires clicking Save once.![](/img/admin-manual/w_0051.png)
![](/img/admin-manual/w_0052.png)
...
![](/img/admin-manual/w_0053.png)
![](/img/admin-manual/w_0054.png)
